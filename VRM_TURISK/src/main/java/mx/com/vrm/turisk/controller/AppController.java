...
public class AppController {
	...
	@RequestMapping(value = { "/#_=_" }, method = RequestMethod.GET)
	public String loginPageFacebook(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		{
			logger.info("--inicia Login Facebook--");
			return "/principal";
		}
	}
	/**
	...
	public ModelAndView homePage(ModelAndView internalModel) {
		...
		for(GrantedAuthority grantedAuthority:auth.getAuthorities()) {
			String currentPrincipal = grantedAuthority.getAuthority();
