...
@EnableJpaRepositories(basePackages = { "mx.com.vrm.turisk.dao" })
...
public class WebAppConfig extends WebMvcConfigurerAdapter {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan(new String[] { "mx.com.vrm.turisk.model" });
	...
	public DataSource dataSource() {
		...
		// LOCAL -CV
		dataSource.setUrl(
				"jdbc:mysql://localhost:3306/vrm_viai?useSSL=false"
				+ "&useUnicode=true&"
