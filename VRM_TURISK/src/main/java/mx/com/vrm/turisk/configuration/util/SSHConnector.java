...
public class SSHConnector {
	 ...
	 *             Cualquier error al establecer conexión SSH.
	 * @throws IllegalAccessException
	 *             Indica que ya existe una conexión SSH establecida.
	 */
	 ...
	 *
	 * @throws IllegalAccessException
	 *             Excepción lanzada cuando no hay conexión establecida.
	 * @throws JSchException
	 *             Excepción lanzada por algún error en la ejecución del comando
	 *             SSH.
	 * @throws IOException
	 *             Excepción al leer el texto arrojado luego de la ejecución del
	 *             comando SSH.
	 */
